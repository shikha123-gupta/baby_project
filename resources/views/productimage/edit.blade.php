   ...
   <div class="container-fluid a">
      <div class="card-shadow">
         <div class="card-heading">
          ...
          <div class="card-body">
            <form action="{{url('/productimage/update')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <img src="{{ url('/upload/'.$data->image) }}" style="height: 70px; width: 70px;border-radius: 80%; ">
               </div>
               <br>
