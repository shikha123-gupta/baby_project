          ...
          <div class="aa-product-details-area">
                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="{{url('upload/' .$data->image)}}" class="simpleLens-lens-image"><img src="{{url('upload/' .$data->image)}}" class="simpleLens-big-image" style="width:100%"></a></div>
                      </div>
                      
                      <div class="simpleLens-thumbnails-container">
                      @foreach($pro as $p)
                          <a data-big-image="{{url('upload/' .$p->image)}}" data-lens-image="{{url('upload/' .$p->image)}}" class="simpleLens-thumbnail-wrapper" style="display: initial;">
                            <img src="{{url('upload/' .$p->image)}}" style="width: 20%;display:initial">
                          </a>   
                      @endforeach                                  
                      </div>
                 ...
                 <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-price-block">
                      <span class="aa-product-view-price fa fa-rupee" >{{$data->price}}</span>
                    ...
                    <div class="aa-prod-quantity">
                      ...
                      <p class="aa-prod-category">
                        Category: <a href="#">{{$data->product_name}}</a>
                      </p>
                    </div>
            ...
            <div class="aa-product-related-item">
              ...
              <ul class="aa-product-catg aa-related-item-slider">
                ...
                <li>
                  <figure>
                    <a class="aa-product-img" href="{{url('front/productdetails/' .$p->id)}}"><img src="{{url('upload/' .$p->image)}}" alt="polo shirt img"style="width:100%"></a>
