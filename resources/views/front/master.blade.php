...
<html lang="en">
  <head>
   ...
   <link href="{{url('css/font-awesome.css')}}" rel="stylesheet">
    ...
    <!-- Theme color -->
    <link id="switcher" href="{{url('css/theme-color/purple-theme.css')}}" rel="stylesheet">
            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="aa-language">
                  <div class="dropdown">
                    <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                      <img src="{{url('img/flag/india.jpg')}}" alt="english flag">INDIA
                      <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                      <li><a href="#"><img src="{{url('img/flag/india.jpg')}}" alt="">INDIA</a></li>
                    </ul>
                  </div>
                </div>
                <!-- / language -->
                ...
                <div class="cellphone hidden-xs">
                  <p><span class="fa fa-phone"></span>91-00-23-34-345</p>
                </div>
                <!-- / cellphone -->
              </div>
              <!-- / header top left -->
